...
# ================= CONFIG =================
BOT_TOKEN = os.getenv("BOT_TOKEN", "8380869816:AAG22QtQxixZYDSatIxtolUWKYSR4uPpm1E")
ADMIN_ID = int(os.getenv("ADMIN_ID", "7327835353"))
...
@app.route('/')
def home():
    return "🚀 Samiul Hosting Bot is running!", 200
...
def premium_menu(user_id):
    ...
    markup.row(types.InlineKeyboardButton("👤 Contact Owner @Samiulislamd", url="https://t.me/Samiulislamd"))
...
def start(message):
    ...
    user_info_text = (
        ...
        f"👤 **Username:** {username}\n"
        f"📝 **Bio:** {bio}\n\n"
        f"Samiul Hosting Bot is a Telegram bot that makes managing your hosting and servers easy. "
...
def got_payment(message):
    ...
    bot.send_message(message.chat.id, "🎉 **Payment Successful!**\n\n✅ Your Premium Plan has been activated! 💎", parse_mode="Markdown")
...
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
  ...
  ✨ "Empowering your code with elite performance" """
        ...
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Message Owner", url="https://t.me/Samiulislamd"))
...
✨ Bot is running smoothly!"""
        ...
        if data_parts[0] == "ADM":
            ...
            if action == "FILE_MAN":
                ...
                save_data(BLOCK_FILE, blocked_users)
                try:
                    bot.send_message(t, "🚫 You have been blocked by an admin. Contact @Samiulislamd for help.")
                except:
                    pass
            ...
            if token not in clone_requests:
                ...
                try:
                    bot.send_message(user_id_req, f"😞 **Your clone request was rejected.**\n\n"
                                                 f"**Bot:** `@{safe_markdown(bot_name)}`\n\n"
                                                 f"Contact @Samiulislamd for questions.", parse_mode="Markdown")
                except:
                    pass
